...
namespace AutoLot.Mvc.Controllers.Base
{
        ...
        where TController:class
    {
        ...
        protected BaseCrudController(IDataServiceBase<TEntity> mainDataService)
        {
        ...
        {
            return await MainDataService.FindAsync(id);
        }
        protected abstract Task<SelectList> GetLookUpValuesAsync();
        // GET: BaseCrudController
        [HttpGet]
        [Route("/[controller]")]
        [Route("/[controller]/[action]")]
        public virtual async Task<IActionResult> IndexAsync()
        {
            return View(await MainDataService.GetAllAsync());
        }
        ...
        public virtual async Task<IActionResult> DetailsAsync(int? id)
        {
            ...
            var entity = await MainDataService.FindAsync(id.Value);
            if (entity == null)
            {
                return NotFound();
            }
